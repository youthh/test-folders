...
- `metDate` — дата знайомства (`"YYYY-MM-DD"`); якщо вказана, під вступом
  з'являється бедж «ми знайомі вже N днів 🙂» (`dateUtils.daysBetween`).
  Порожній рядок прибирає бедж повністю;
